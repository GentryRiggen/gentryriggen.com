        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-5">
            <a
              ...
              className="p-4 bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 rounded-full text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 active:scale-95"
              aria-label="LinkedIn"
            >
              <svg
